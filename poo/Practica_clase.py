class Dispositivo:
    def __init__(self, marca):
        self.marca = marca
        self.__encedido = False
        
    def encender(self):
        self.__encedido = True
        return f"El dispositivo de {self.marca} esta encendido..."
...
class Camara:
    ...
    def tomar_foto(self):
        return f"Wisssskiiii. se tomo foto desde a {self.megapixeles}"
...
print(mi_celular.hacer_llamada('Juan'))
